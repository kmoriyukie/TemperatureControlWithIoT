...
#remoteCoAPServerIP = socket.gethostbyname("localhost")
remoteCoAPServerIP = "fe80::212:4b00:89ab:cdef"
remoteCoAPServerPort = 5683

localCoAPClient = "fd00::c30c:0:0:2"
localCoAPPort = 5683
...
def IPv6ServerThread(name):
	...
	while(True):
		...
		UDPIPv6ServerSocket.sendto(message, (remoteCoAPServerIP, remoteCoAPServerPort))
